...
11. In the **New Relationship** window, in the first dropdown list, select the **Product** table.
...
7. In the **Data** pane, inside the **Sales** table, notice that new measure.
...
13. In the **Data** pane, check the two measures.
