...
4. In the **Open** window, navigate to the **C:\DA100\Labs\09-create-power-bi-dashboard\Solution** folder.
...
7. In the **Save As** window, navigate to the **C:\DA100\MySolution** folder.
