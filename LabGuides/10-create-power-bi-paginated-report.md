...
1. In the **Save As Report** window, navigate to the **C:\DA100\MySolution** folder.
...
1. In the **Open** window, navigate to the **C:\DA100\Resources** folder, and then select the **AdventureWorksLogo.jpg** file.
...
13. In the **Import Query** window, navigate to the **C:\DA100\Labs\10-create-power-bi-paginated-report\Assets** folder, and then select the **SalesOrder.sql** file.
