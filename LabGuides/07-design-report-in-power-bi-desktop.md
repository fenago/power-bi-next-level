...
8. In the **Open** window, navigate to the **C:\DA100\Labs\07-design-report-in-power-bi-desktop\Starter** folder.
...
4. In the **Open** window, navigate to the **C:\DA100\Resources** folder.
